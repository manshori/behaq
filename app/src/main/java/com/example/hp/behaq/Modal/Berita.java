...
public class Berita {
    ...
    public Berita(int id, String query, String name, String url, String snippet, int count_verified, int count_hoax, int sentiment, int label, int content_id, String space_id) {
        this.id = id;
        this.query = query;
        this.name = name;
        this.url = url;
